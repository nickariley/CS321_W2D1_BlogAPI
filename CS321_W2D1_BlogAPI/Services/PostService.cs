...
namespace CS321_W2D1_BlogAPI.Services
{
    public class PostService : IPostService
    {
        ...
        public Post Add(Post post)
        {
            ...
            //XTODO: add the new post to the list of posts (_posts)
            _posts.Add(post);
        ...
        public Post Get(int id)
        {
            ...
            //XTODO: use FirstOrDefault() to find the Post by id in _posts and return it
        ...
        {
            //XTODO: return the full list of posts
            return _posts;
        }
        ...
        public Post Update(Post updatedPost)
        {
            ...
            //XTODO: find the post to update in the list, using updatedPost.Id, and assign to currentPost
            Post currentPost;

            currentPost = _posts.FirstOrDefault(p => p.Id == updatedPost.Id);
            ...
            //XTODO: copy the values in updatedPost to the post you found in the list
        ...
        {
            //XTODO: remove the post from _posts
